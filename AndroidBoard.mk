...
ALL_PREBUILT += $(file)
$(file) : vendor/deckard/proprietary/usr/keylayout/SH_headset_key.kl | $(ACP)
	$(transform-prebuilt-to-target)

file := $(TARGET_OUT_KEYLAYOUT)/SH_pm_key.kl
ALL_PREBUILT += $(file)
$(file) : vendor/deckard/proprietary/usr/keylayout/SH_pm_key.kl | $(ACP)
	$(transform-prebuilt-to-target)

file := $(TARGET_OUT_KEYLAYOUT)/SH_qwerty_key.kl
ALL_PREBUILT += $(file)
$(file) : vendor/deckard/proprietary/usr/keylayout/SH_qwerty_key.kl | $(ACP)
	$(transform-prebuilt-to-target)
